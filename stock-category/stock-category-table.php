  ...
  {
      $search =$_POST["query"];
      $query_r_view = "SELECT * FROM categoryreportinfor WHERE title LIKE '%".$search."%' ";
  }
  else
  {
      $query_r_view ="SELECT * FROM categoryreportinfor";
  }
  ...
  <table id="editable_table" class="table table-sm">
       ...
       while($row = mysqli_fetch_array($result_r_view))
       {
        ...
        <tr>
          ...
          <td><a href="stock-category-view1?cview_id='.$row["id"].'&update=true">View</a></td>
