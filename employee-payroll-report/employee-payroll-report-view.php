...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="back_btn">
        <input type="button" value="Go Back" onclick="window.location='employee-payroll-report';" class="btn btn-primary btn-sm" />
      </div>
       <br>
       <div id="result">
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"./employee-payroll-report-table",
   method:"POST",
   data:{query:query},
