  ...
  if(isset($_POST["query"]))
  {
      $search =$_POST["query"];
      $query_r_view = "
      SELECT * FROM repayroll
      WHERE title LIKE '%".$search."%' ";
  }
  else
  {
      $query_r_view ="SELECT * FROM repayroll";
  }
  ...
  <table id="editable_table" class="table table-sm">
       ...
       while($row = mysqli_fetch_array($result_r_view))
       {
        ...
        <tr>
          ...
          <td><a href="employee-payroll-report-view1?pview_id='.$row["id"].'&update=true">View</a></td>
